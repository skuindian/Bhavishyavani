#-------------------------------------------------
#
# Project created by QtCreator 2018-10-15T22:40:18
#
#-------------------------------------------------

QT       -= gui

TARGET = ActivityReminderHelper
TEMPLATE = lib

DEFINES += ACTIVITYREMINDERHELPER_LIBRARY
...
SOURCES += \
        src/helper/ActivityReminderConfigReader.cpp

HEADERS += \
        src/helper/ActivityReminderConfigReader.h
